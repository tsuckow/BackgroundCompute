...
public class TestLocalFile extends TestCase
{
	...
	private String getLocalHash(String file)
	{
		return (String) MethodUtils.invokeMethod( 
			getLocalHash_String, null, file
		);
	}
	
	private String[] getLocalList(String file)
	{
		return (String[]) MethodUtils.invokeMethod( 
			getLocalList_String, null, file
		);
	}
	...
	public void testHash4Line_EndBlank()
	{
		assertEquals(
			...
			getLocalHash( "TestFiles" + File.separator + "FourLines_EndBlank.txt" )
		);
	}
	...
	public void testHash4Line_MidBlank()
	{
		assertEquals(
			...
			getLocalHash( "TestFiles" + File.separator + "FourLines_MidBlank.txt" )
		);
	}
	...
	public void testList4Line()
	{
		assertTrue(
			Arrays.equals(
				new String[] {"Line 1","Line 2","Line 3","Line 4"},
				getLocalList( "TestFiles" + File.separator + "FourLines.txt" )
			)
		);
	}
	...
	public void testList4Line_EndBlank()
	{
		assertTrue(
			Arrays.equals(
				new String[] {"Line 1","Line 2","Line 3","Line 4"},
				getLocalList( "TestFiles" + File.separator + "FourLines_EndBlank.txt" )
			)
		);
	}
	...
	public void testList4Line_MidBlank()
	{
		assertTrue(
			Arrays.equals(
				new String[] {"Line 1","Line 2","","Line 3","Line 4"},
				getLocalList( "TestFiles" + File.separator + "FourLines_MidBlank.txt" )
			)
		);
	}
